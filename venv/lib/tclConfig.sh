...
# installed.
TCL_PREFIX='/Users/bryansteiner/Github/nuclear-impact-data/venv'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/bryansteiner/Github/nuclear-impact-data/venv'
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/bryansteiner/Github/nuclear-impact-data/venv/lib -L/Users/bryansteiner/Github/nuclear-impact-data/venv/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/bryansteiner/Github/nuclear-impact-data/venv/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/bryansteiner/Github/nuclear-impact-data/venv/include'
...
TCL_PACKAGE_PATH='/Users/bryansteiner/Github/nuclear-impact-data/venv/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/bryansteiner/Github/nuclear-impact-data/venv/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/Users/bryansteiner/Github/nuclear-impact-data/venv/lib/libtclstub8.6.a'
